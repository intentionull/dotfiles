...
-- honestly thanks to the rad lectures for this config. Too much to type, good stuff here
-- cant believe mouse is enabled though
-- ================================================================================================
...
vim.opt.timeoutlen = 800 -- Time in ms to wait for mapped sequence
